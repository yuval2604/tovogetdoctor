              ...
              <div className="about-contain">
                <div>
                  ...
                  <p className="caption-about">
                    ...
                    אסנה היינו מנהל המערך האונקלוגי בבית החולים ברזרילי. מר ארז
                    בייזר מנהל תפעול רדיותרפיה המערך האונקלוגי סוראסקי. מנסיוננו
                    המקצועי נחשפנו לפערים הקיימים במערכת הבריאות בין דרישות
                    וצרכי המטופלים לבין זמינות המערכת הציבורית והפרטית ולכן
                    לקחנו על עצמנו את האתגר למצוא דרכים להנגיש שירותי רפואה
                    במינימום זמן ומקסימום נוחות לקהל הרחב..
                  </p>
